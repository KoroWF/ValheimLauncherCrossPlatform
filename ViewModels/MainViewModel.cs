...
namespace ValheimLauncher2.ViewModels
{
 ...
 // HERE IS THE FIX: START THE SCRIPT IN A NEW TERMINAL
 try
 {
 ...
 // Only HERE, when the actual work begins, we set IsBusy
 IsBusy = true;
 try
 {
 ...
 //3. Delete the source, but ONLY if it's not a Steam folder.
